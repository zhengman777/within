...
class Street(pygmi.Room):
    ...
    def __init__(self,game):
        ...
        game.createInstance(bgStreet)
        game.createInstance(oShadowBoy)
        game.createInstance(oShadowApathol)
        game.createInstance(oBoy)
        game.createInstance(oHUD)
        game.createInstance(oApathol)